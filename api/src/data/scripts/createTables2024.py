...
CREATE TABLE IF NOT EXISTS nba_main_2024 (
...
CREATE TABLE IF NOT EXISTS nba_advanced_2024 (
    player_id INT NOT NULL,
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS epm_2024 (
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS bbref_2024 (
  player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS lebron_2024(
  player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS rpm_2024 (
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS wpa_2024 (
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS raptor_2024 (
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS fic_2024 (
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS dpm_2024 (
    player_name VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS umbinaam_2024 (
    player_name VARCHAR(45) NOT NULL,
...
query_list = [create_nba_main_table_query, create_nba_advanced_table_query, create_epm_table_query,
              ...
              create_raptor_table_query, create_fic_table_query, create_dpm_table_query, create_umbinaam_table_query]
