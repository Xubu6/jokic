-- SELECT ROW_NUMBER() OVER(ORDER BY ws_per_48 DESC) AS rk, nba.player_id, nba.player_name, nba.team_abbreviation, nbaa.net_rating, nbaa.pie, bbref.per, bbref.ws_per_48, bbref.bpm, bbref.vorp, epm.epm, epm.e_wins, lebron.lebron, lebron.bbi_war, rpm.rpm, rpm.rpm_wins, wpa.wpa, wpa.k_wpa, raptor.raptor, raptor.raptor_war, fic.ts, fic.fic, dpm.dpm
